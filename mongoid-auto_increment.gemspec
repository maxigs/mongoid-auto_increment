Gem::Specification.new do |s|
  ...
  s.files     = ['lib/mongoid-auto_increment.rb', 'lib/mongoid/auto_increment.rb', 'lib/mongoid-auto_increment/railtie.rb', 'lib/mongoid-auto_increment/railties/auto_increment.rb']
